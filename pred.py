...
# Train the model
model_k.train(X_train, y_train, epochs=1000, batch_size=32)
# Predict
...
model_k.plot_loss()
plt.savefig(f'keras_model_trainning_{accuracy}.png')
...
plt.savefig('keras_model_prediction.png')
...
# Créer le modèle
mlp = MLP(input_dim=X_train.shape[0], output_dim=1, hidden_layers=(16,), learning_rate=0.1, n_iter=1000)
# Entraîner le modèle
